...
class Status extends React.Component {
    ...
    render() {
        return <>{!this.state.editMode ?
            ...
            :
            <span>
                      <input onChange={this.onStatusChange} autoFocus={true} className={styles.Input}
                             onBlur={this.deactivateEditMode} type="text" value={this.state.status} maxLength={300}/>
