...
let FormUpdateProfile = props => {
    return (<form onSubmit={props.handleSubmit} className={Set.Form}>
        <div className={styles.Input}>
            ...
            <Field type={'text'} placeholder={'change name'} component={InputField} name={'fullName'}
                   validate={required}/>
        </div>
        ...
        <div className={styles.Input}>
            ...
            <Field type={'text'} placeholder={'looking for a job description'} component={InputField}
...
const UpdateProfile = props => {
    ...
    return (<>
        ...
        <FormUpdate profile={props.profile} onSubmit={saveChanges} initialValues={props.profile}
                    isUpload={props.isUploadProfile}/>
    </>)
}
